...
function getRedirectUrlForPlanBumpOffer( { pendingOrReceiptId, cart, selectedSiteSlug } ) {
...
function getRedirectUrlForGSuiteNudge( {
	...
	if ( domainForGSuite ) {
		return (
			getRedirectUrlForPlanBumpOffer( { pendingOrReceiptId, cart, selectedSiteSlug } ) ||
			`/checkout/${ selectedSiteSlug }/with-gsuite/${ domainForGSuite.meta }/${ pendingOrReceiptId }`
		);
	}
}
